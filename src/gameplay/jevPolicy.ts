...
function actionCriteria(): Record<GameplayActionType, string> {
  return {
    ...
    PLACE_ITEM: 'Place a carried item at a specified location.',
    USE_ITEM: 'Use a selected held item.',
    PROCESS_ITEM: 'Legacy processing adapter.',
    INTERACT_BLOCK: 'Activate a specified block.',
    COOK_FOOD: 'Legacy cooking adapter.',
    OPERATE: 'Execute a validated basic operation.',
