      ...
      const response = await fetch('https://api.openai.com/v1/responses', {
        ...
        body: JSON.stringify({
          ...
          instructions: [
            ...
            'Use state.capabilities.actions as the source of truth for what operations are currently executable. These affordances are derived from Minecraft state/specifications, not from a prescribed progression.',
